...
packer.startup {
  function(use)
    ...
    use{"akinsho/toggleterm.nvim", config= function() require("toggleterm").setup({start_in_insert=true, direction='float'}) end}
    ...
    use { "j-hui/fidget.nvim", tag = "legacy", after = "nvim-lspconfig", config = [[require('config.fidget-nvim')]] }
  end,
  config = {
    max_jobs = 16,
